...
function addFeedback(){
  ...
  function createFeedback(feedback){
  	...
  	responseRow.innerHTML = '<div class = "row"><p><div class = col-lg><span class="h3 pull-left">'+ nameText + '' +
		'</span><span class="h5 pull-right">' + dateString + '</span></p><p><span class="h3 pull-right">' + responseText +
		'</span></p></div></div><hr>';
